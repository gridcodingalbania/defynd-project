...
(function($) {
    ...
    const yesOption = document.getElementById("id_total_demolition_0");
    const noOption = document.getElementById("id_total_demolition_1");

    if(yesOption) {
        yesOption.onclick = function() {
            const partialDemolitionInput = document.getElementById("id_partial_demolition_container")
            if(partialDemolitionInput) {
                partialDemolitionInput.style.display = "none";
            }
        }
    }
    if(noOption) {
        noOption.onclick = function() {
            const partialDemolitionInput = document.getElementById("id_partial_demolition_container")
            if(partialDemolitionInput) {
                partialDemolitionInput.style.display = "block";
            }
        }
    }
